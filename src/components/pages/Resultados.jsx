...
export default function Resultados() {
  return (
    <div>
        ...
        >
          <span><i className="bi bi-list primary-color"></i></span>
        </button>
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-3 mb-lg-0" id="navbar-items">
            ...
            <li className="nav-item primary-color">
              <a className="nav-link" href="#">Buscar Loja</a>
            </li>
            <li className="nav-item primary-color">
              <a className="nav-link" href="#">para proprietários</a>
            </li>
            <li className="nav-item primary-color">
              ...
              >
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      <small className="text-muted">Loja de shopping. 80m²</small>
                    </p>
                    <p className="card-text">
              ...
              >
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      <small className="text-muted">Loja de shopping. 150m²</small>
                    </p>
                    <p className="card-text">
              ...
              >
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      <small className="text-muted">Loja de shopping. 65m²</small>
                    </p>
                    <p className="card-text">
              ...
              >
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      <small className="text-muted">Loja de shopping. 100m²</small>
                    </p>
                    <p className="card-text">
              ...
              >
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      <small className="text-muted">Loja de shopping. 70m²</small>
                    </p>
                    <p className="card-text">
                      <small className="text-muted">R$ 13.000/mês</small>
                    </p>
              ...
              >
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      <small className="text-muted">Loja de shopping. 250m²</small>
                    </p>
                    <p className="card-text">
    ...
    <footer>
      <section className="about mt-4">
        ...
        <ul>
          <li><a href="#">Conheça o SobreLoja</a></li>
